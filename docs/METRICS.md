...
- `AGENTS.md` placeholder enforcement (`[PLACEHOLDER]` markers fail the run)
...
✅ AGENTS.md contains no [PLACEHOLDER] markers.
...
Generated by `npm run metrics` on **2026-05-14 11:12:26Z** for the last **14 days**.

| Metric | Value | Notes |
|---|---:|---|
| Rework rate | 0.0% (0/6482 changed lines) | ✅ Healthy; rework is inside target. |
| PR revision rate | 0.0% (0/0 merged PRs revised) | No merged PRs found in the window. |
