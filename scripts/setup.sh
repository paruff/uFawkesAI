...
echo -e "  4. ${YELLOW}Once real source code lands${NC}, replace the no-op lint/typecheck/test:coverage"
echo "     scripts in package.json with your actual toolchain — they pass by design until then"
echo ""
